...
odd dbt ingest-test --profiles-dir profiles -t $ODD_COLLECTOR_TOKEN -h $ODD_PLATFORM_HOST -oddrn //dbt/host/localhost
odd dbt ingest-lineage  --profiles-dir profiles -t $ODD_COLLECTOR_TOKEN -h $ODD_PLATFORM_HOST -oddrn //dbt/host/localhost
